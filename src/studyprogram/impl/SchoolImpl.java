 ...
 * </p>
 * <ul>
 *   <li>{@link studyprogram.impl.SchoolImpl#getDepartments <em>Departments</em>}</li>
 *   <li>{@link studyprogram.impl.SchoolImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SchoolImpl extends MinimalEObjectImpl.Container implements School {
	...
	protected EClass eStaticClass() {
		return StudyprogramPackage.Literals.SCHOOL;
	}
	...
	public EList<Department> getDepartments() {
		if (departments == null) {
			departments = new EObjectContainmentWithInverseEList<Department>(Department.class, this, StudyprogramPackage.SCHOOL__DEPARTMENTS, StudyprogramPackage.DEPARTMENT__SCHOOL);
		}
		return departments;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StudyprogramPackage.SCHOOL__NAME, oldName, name));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case StudyprogramPackage.SCHOOL__DEPARTMENTS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case StudyprogramPackage.SCHOOL__NAME:
				return getName();
		}
