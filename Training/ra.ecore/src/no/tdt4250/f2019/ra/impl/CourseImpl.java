 ...
 * </p>
 * <ul>
 *   <li>{@link no.tdt4250.f2019.ra.impl.CourseImpl#getName <em>Name</em>}</li>
 *   <li>{@link no.tdt4250.f2019.ra.impl.CourseImpl#getCode <em>Code</em>}</li>
 *   <li>{@link no.tdt4250.f2019.ra.impl.CourseImpl#getAllocations <em>Allocations</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CourseImpl extends MinimalEObjectImpl.Container implements Course {
	...
	public EList<ResourceAllocation> getAllocations() {
		if (allocations == null) {
			allocations = new EObjectWithInverseResolvingEList<ResourceAllocation>(ResourceAllocation.class, this, RaPackage.COURSE__ALLOCATIONS, RaPackage.RESOURCE_ALLOCATION__COURSE);
		}
		return allocations;
	}
