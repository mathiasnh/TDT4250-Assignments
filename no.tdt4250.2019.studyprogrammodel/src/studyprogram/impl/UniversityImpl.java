 ...
 * </p>
 * <ul>
 *   <li>{@link studyprogram.impl.UniversityImpl#getDepartments <em>Departments</em>}</li>
 *   <li>{@link studyprogram.impl.UniversityImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UniversityImpl extends MinimalEObjectImpl.Container implements University {
	...
	protected EClass eStaticClass() {
		return StudyprogramPackage.Literals.UNIVERSITY;
	}
	...
	public EList<Department> getDepartments() {
		if (departments == null) {
			departments = new EObjectContainmentWithInverseEList<Department>(Department.class, this, StudyprogramPackage.UNIVERSITY__DEPARTMENTS, StudyprogramPackage.DEPARTMENT__SCHOOL);
		}
		return departments;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StudyprogramPackage.UNIVERSITY__NAME, oldName, name));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case StudyprogramPackage.UNIVERSITY__DEPARTMENTS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case StudyprogramPackage.UNIVERSITY__NAME:
				return getName();
		}
